...
public class Guybrush {
	...
	private int key, lastKey, counter = 0, currentImageIndex;
	...
	private void changePosition(int valueX, int valueY) {
		position.setLocation(position.x + valueX, position.y + valueY);
	}
